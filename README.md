...
sh
  cd my-folder
 git clone https://github.com/theodoku/react-todoapp.git
...
- [ ] **[I intend to add three more pages for users to navigate]**
...
Feel free to check the [issues page](https://github.com/theodoku/react-todoapp.git/issues).
